...
<strong>View LabResults</strong>

<table class="table">
<c:set var="pid" value="${pid}"></c:set><c:set var="eid" value="${eid}"></c:set>
<tr><td>LabTest Type</td><td>${e.labTestType }</td></tr>
<tr><td>Lab Results</td><td>${e.labTestResults}</td></tr>
<tr><td colspan="2"><a href="/webtools/doctor/suggestmedication?pid=${pid}&eid=${eid}" class="btn btn-info">Prescribe Medication</a>
</table>
